				...
				<div class="col-lg-6">
					<div class="details_content">
                        ...
                        @if ($item->discount_price !== null)
									<div class="details_discount">&euro; {{ number_format($item->price, 2) }}</div>
									<div class="details_price">&euro; {{ number_format($item->discount_price, 2) }}</div>
								@else
									<div class="details_price">&euro; {{ number_format($item->price, 2) }}</div>
								@endif
						<!-- In Stock -->
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="/mages/product_2.jpg" alt=""></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="/mages/product_3.jpg" alt=""></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="/mages/product_4.jpg" alt=""></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
